...
#   Zusatzbeitrag:      krankenkassen.de/gesetzliche-krankenkassen/krankenkasse-beitrag/kein-zusatzbeitrag 
        ...
        if jahr == "2022":      
            ...
            jw['ZU'] = { "1510": "0.75", "1512" : "0.0",  "1514" : "0.55", "1515": "0.645", "1517": "0.60",
                         "1518": "0.75", "1522": "0.45", "1523": "0.6" , "1579": "0.1687" }  [ jw['NR'] ]  #  1523: ab Mai 0.5  #  0.001687 = 0.0025 / (1 - 0.185 - 0.102 - 0.017 - 0.006)
            jw['ZA'] = { "1510": "0.75", "1512" : "0.0",  "1514" : "0.55", "1515": "0.645", "1517": "0.60",
            ...
            jw['U1'] = { "1510" : "2.2",  "1512" : "0.9", "1514": "1.1", "1515": "1.7", "1517": { "123456789": "1.6", "ABC": "2.6" }[zeitraum],
                         "1518":  "2.0",  "1522": "1.4",  "1523": "1.7"  , "1579": "0.1" }  [ jw['NR'] ]  
            jw['U2'] = { "1510" : "0.65", "1512" : "0.24", "1514": "0.46", "1515": "0.56", "1517":  { "123456789": "0.65", "ABC": "0.58" }[zeitraum],
        ...
        if jahr == "2023":      
            ...
            for zeitraum1 in ("12345678","9ABC"):
                if monat in zeitraum1:
                    break


            jw['RLIMIT']  = ["7300",   "7300",   "99999999" ][ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ]    #  ist tatsaechlich abgesenkt!
            jw['KLIMIT']  = ["4987.50","4987.50","99999999" ][ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ] 
            jw['RV'] = ["9.3" ,"15" ,"18.5" ]    [ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ] 
            jw['AV'] = ["1.3" ,"3.6","10.2" ]    [ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ] 
            jw['KV'] = ["7.3","13","1.7"]        [ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ] 
            jw['KG'] = ["0.3","0.0","0.0"]       [ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ]  
            jw['ZU'] = { "1510": "0.85", "1512" : "0.0",  "1514" : "0.55", "1515": "0.745", "1517": "0.60",
                         "1518": "0.75", "1522": "0.45", "1523": "0.6" , "1579": "0.1687" }  [ jw['NR'] ]  #  1523: ab Mai 0.5
            jw['ZA'] = { "1510": "0.85", "1512" : "0.0",  "1514" : "0.55", "1515": "0.745", "1517": "0.60",
                         "1518": "0.75", "1522": "0.45", "1523": "0.6" , "1579": "0.1" }  [ jw['NR'] ]  #  1523: ab Mai 0.5
            jw['ZV'] = "1.3"  # der DURCHSCHNITTLICHE Wert der Krankenkassen-Arbeitnehmerzuschlaege
            if zeitraum == "123456":
                jw['PV'] = [ "1.525","1.525","0.6" ] [ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ]  
                jw['PZ'] = ["0.35","0.35","0.00"]    [ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ]  
            else:
                jw['PV'] = [ "1.7","1.7","0.6" ] [ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ]  
                jw['PZ'] = ["0.6","0.6","0.00"]  [ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ]  
            jw['U1'] = { "1510" : "2.9",  "1512" : "0.9", "1514": "1.1", "1515": "2.7", "1517": "2.6",
                         "1518":  "2.8",  "1522": "1.4",  "1523": "1.7"  , "1579": "0.1" }  [ jw['NR'] ]  
            jw['U2'] = { "1510" : { "12345678": "0.52", "9ABC": "0.39" }[zeitraum1], "1512" : "0.24", "1514": "0.46", "1515": "0.40", "1517": "0.58",
                             "1518":  "0.54", "1522": "0.41", "1523": "0.39" , "1579": "0.0" } [ jw['NR'] ]  
            jw['U3'] = [ "0.09" ,"0.09","0.00"]  [ int( jw['NR'] == "1512" ) + 2*int( jw['NR'] == "1579")  ] 
