...
#********************************************************************************
    ...
    def parse_beitragsnachweise (self):
        ...
        for beitragsnachweis in beitragsnachweise:
            ...
            m = re.search(r"_MODE(\d+)_",beitragsnachweis)
            mode = 0
            if m:
                mode = int(m.group(1))
            ...
            if mode > 0:
                newname = newname + "__MODE" + str(mode)
...
#                    continue
                ...
                if abs(betrag1) > 0.0001:
                    buchungen.append(datum + "  " +  '%3.2f' % betrag1 + "  " + self.ktoa  + ktoa +  "  " + self.ktob + ktob + "  0.00  " + remarkadd + remark1)
#                    print(buchungen[-1])
